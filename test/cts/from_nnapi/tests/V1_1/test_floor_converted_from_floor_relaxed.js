...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test floor converted from floor_relaxed test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([1, 2, 2, 2]), outputs.op2.resource), expected, utils.ctsFp32RelaxedAccuracyCriteria);
  });
});
/* eslint-disable max-len */
