...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test softmax converted from softmax_float_2_relaxed test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([2, 5]), outputs.output.resource), expected, utils.ctsFp32RelaxedAccuracyCriteria);
  });
});
/* eslint-disable max-len */
