...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test transpose converted from transpose_float_1 test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([4, 2, 3, 5]), outputs.output.resource), expected, utils.ctsFp32RestrictAccuracyCriteria);
  });
});
/* eslint-disable max-len */
