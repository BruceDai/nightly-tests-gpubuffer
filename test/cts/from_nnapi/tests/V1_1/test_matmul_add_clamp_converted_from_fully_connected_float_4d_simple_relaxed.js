...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test matmul + add + clamp converted from fully_connected_float_4d_simple_relaxed test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([2, 3]), outputs.op3.resource), expected, utils.ctsFp32RelaxedAccuracyCriteria);
  });
});
/* eslint-disable max-len */
