...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test pad converted from pad_float_1 test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([1, 4, 7, 1]), outputs.op3.resource), expected, utils.ctsFp32RestrictAccuracyCriteria);
  });
});
/* eslint-disable max-len */
