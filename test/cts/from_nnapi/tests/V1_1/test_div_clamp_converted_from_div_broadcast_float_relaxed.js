...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test div + clamp converted from div_broadcast_float_relaxed test', async function() {
    ...
    const op2Resource = {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([2, 2]), [1, 1, 2, 2])};
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([2, 2]), outputs.op3.resource), expected, utils.ctsFp32RelaxedAccuracyCriteria);
  });
});
/* eslint-disable max-len */
