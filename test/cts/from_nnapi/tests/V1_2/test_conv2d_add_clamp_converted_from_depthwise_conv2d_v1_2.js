...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test conv2d + add + clamp converted from depthwise_conv2d_v1_2_large_nchw test', async function() {
    ...
    const op22 = builder.constant({type: 'float32', dimensions: [1, 2, 2, 2]}, {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([1, 2, 2, 2]), [0.25, 0, 0.25, 1, 0.25, 0, 0.25, 1])});
    const op32 = builder.constant({type: 'float32', dimensions: [1, 2, 1, 1]}, {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([2]), [100, 200])});
    const param13 = 0;
    const param14 = 0;
    const param15 = 0;
    const param16 = 0;
  ...
  it('test conv2d + add + clamp converted from depthwise_conv2d_v1_2_large_nchw_2 test', async function() {
    ...
    const op23 = builder.constant({type: 'float32', dimensions: [1, 2, 2, 4]}, {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([1, 2, 2, 4]), [0.25, 0, 10, 50, 0.25, 1, 20, 50, 0.25, 0, 30, 50, 0.25, 1, 40, 50])});
    const op33 = builder.constant({type: 'float32', dimensions: [1, 4, 1, 1]}, {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([4]), [6000, 7000, 8000, 9000])});
    const param21 = 0;
    const param22 = 0;
    const param23 = 0;
    const param24 = 0;
