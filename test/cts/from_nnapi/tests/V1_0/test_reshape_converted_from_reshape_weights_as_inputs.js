...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test reshape converted from reshape_weights_as_inputs test', async function() {
    // Converted test case (from: V1_0/reshape_weights_as_inputs.mod.py)
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([9]), outputs.op3.resource), expected, utils.ctsFp32RestrictAccuracyCriteria);
  });
});
/* eslint-disable max-len */
