...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test matmul + add + relu converted from fully_connected_float_2 test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([2, 16]), outputs.op3.resource), expected, utils.ctsFp32RestrictAccuracyCriteria);
  });
});
/* eslint-disable max-len */
