...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test matmul + add + clamp converted from fully_connected_float_large test', async function() {
    ...
    const b0 = builder.constant({type: 'float32', dimensions: [1]}, {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([1]), [900000])});
