...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test l2Pool2d + clamp converted from l2_pool_float_large test', async function() {
    ...
    utils.checkValue(await utils.readbackGPUBuffer(device, utils.sizeOfShape([1, 1, 1, 3]), outputs.op3.resource), expected, utils.ctsFp32RestrictAccuracyCriteria);
  });
});
/* eslint-disable max-len */
