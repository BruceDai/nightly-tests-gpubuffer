...
describe('CTS converted from NNAPI CTS', function() {
  ...
  it('test conv2d (fused ops) converted from depthwise_conv2d_float_large_2_weights_as_inputs test', async function() {
    ...
    const op3Resource = {resource: await utils.createGPUBuffer(device, utils.sizeOfShape([4]), [600000, 700000, 800000, 900000])};
    const pad0 = 0;
    const stride = 1;
